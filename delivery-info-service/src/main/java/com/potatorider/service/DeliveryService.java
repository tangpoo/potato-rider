...
public class DeliveryService {
  ...
  public Mono<Delivery> saveDelivery(final Delivery delivery) {
    return deliveryRepository
        ...
        .flatMap(del -> deliveryPublisher.sendAddDeliveryEvent(del).retryWhen(retryBackoffSpec()));
  }
  ...
  public Mono<Delivery> acceptDelivery(final String deliveryId) {
    return deliveryRepository
        ...
        .flatMap(del -> deliveryPublisher.sendSetRiderEvent(del).retryWhen(retryBackoffSpec()));
  }
